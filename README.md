...
## Setup
 ...
 1. At some point later when you're asked to run `bin/whitelist ...`, do so. Then, add this line to the bottom of the file that appears in the root of the folder called `whitelist.yml`:
